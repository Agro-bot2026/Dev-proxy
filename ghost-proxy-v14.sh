...
logo_ubuntu(){
  ...
  echo "  +sssssssshmdMMMMMMMNddddysssssssss+"
  echo "  /ssssssssNMMMMMMMhssssssssssssssss/"
  echo " .ssssssssshMMNNmdyssssssssssssssssss."
  echo " +sssssssssydsssssssssssssssssssssssss+"
